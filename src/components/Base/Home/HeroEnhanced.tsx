          ...
          >
            ...
            >
              <Link href="/upload">
                <Button
                  size="lg"
                  className="group relative w-full overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 to-blue-600 px-8 py-6 text-lg font-semibold text-white shadow-xl transition-all duration-300 hover:shadow-2xl hover:scale-105 sm:w-auto"
                >
              ...
              <Button
                ...
                className="group w-full rounded-2xl border-2 border-gray-600 bg-gray-600 px-8 py-6 text-lg font-semibold text-pink-300 shadow-lg backdrop-blur-sm transition-all duration-300 hover:border-gray-700 hover:bg-gray-700 hover:shadow-xl hover:scale-105 sm:w-auto"
              >
                <ListChecks className="mr-3 text-pink-300" />
            ...
            >
              {trustIndicators.map((indicator, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-2 rounded-full bg-gray-600 px-4 py-2 shadow-md backdrop-blur-sm"
                >
                  {indicator.icon}
                  <span className="font-medium text-pink-300">{indicator.text}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
